...
const Projets = ({ onProjectSelect }: ProjetsProps) => {
  const projects = [
    {
      ...
      githubUrl: "https://github.com/mohamedchehem/ecommerce-platform",
    ...
    },
    {
      ...
      description: "Application mobile pour restaurant avec commande en ligne et système de réservation",
    ...
    },
    {
      ...
      description: "Tableau de bord météo avec prévisions détaillées et géolocalisation",
    ...
    },
    {
      ...
      description: "Tableau de bord pour gérer plusieurs comptes de réseaux sociaux avec analytics et programmation de posts",
  ...
  return (
    <section id="projets" className="py-20 bg-gradient-to-br from-orange-900 via-red-800 to-pink-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Mes <span className="bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 bg-clip-text text-transparent">Projets</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl overflow-hidden hover:bg-white/15 transition-all duration-300 hover:scale-[1.02] group">
              {/* Image du projet */}
              ...
              <div className="p-6">
                ...
                <p className="text-orange-100 text-sm mb-4 leading-relaxed">{project.description}</p>
